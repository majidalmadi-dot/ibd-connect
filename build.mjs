...
const APPS = [
  ...
  { id: 'maeen',  file: 'EoE/index.html',   sw: 'EoE/sw.js',   tokens: { APP: 'maeen', MAIN: "'today','track','scores','learn','more'"   }, modules: ['telemetry', 'backup-crypto', 'shell-ui', 'themes', 'router'] },
  { id: 'qawam',  file: 'Qawam/index.html', sw: 'Qawam/sw.js', tokens: { APP: 'qawam', MAIN: "'today','track','progress','learn','more'" }, modules: ['telemetry', 'backup-crypto', 'shell-ui', 'themes', 'router'] },
];
